...
Route::group(['middleware' => ['auth']], function() {
    ...
    */
    ...
    Route::post('V2_doviz_kur_getir', [Teklif_fiyat_analizV2::class, 'doviz_kur_getir'])->name('V2_doviz_kur_getir');
    Route::post('V2_recetedenHesapla', [Teklif_fiyat_analizV2::class, 'recetedenHesapla'])->name('V2_recetedenHesapla');
    ...
    Route::post('V2_getDovizKuru', [Teklif_fiyat_analizV2::class, 'getDovizKuru'])->name('V2_getDovizKuru');
    ...
    Route::post('/copy/row', [Teklif_fiyat_analizV2::class, 'copy']);
    Route::post('/get_teklif_gecmisi', [Teklif_fiyat_analizV2::class, 'get_history']);
