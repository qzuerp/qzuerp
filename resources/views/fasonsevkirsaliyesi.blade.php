                          ...
                          <tbody>
                            @foreach ($res as $key => $value)
                              ...
                              <tr>
                                ...
                                <td><input type="date" class="form-control" name="TERMIN_TAR[]" value="" readonly></td>
                                ...
                                <td class="d-flex">
                                  ...
                                  <span class="d-flex -btn">
                                    <button class="btn btn-primary" data-bs-toggle="modal" onclick="getSip('{{ $TRNUM }}')" data-bs-target="#modal_popupSelectModal5" type="button">
                                      <span class="fa-solid fa-magnifying-glass">
                                      </span>
                                    </button>
                                  </span>
