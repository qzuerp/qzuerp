      ...
      <div>
        ...
        <div class="row ">
          ...
          <div class="col-md-2 col-sm-4 col-xs-6">
            ...
            <select class="form-control select2 js-example-basic-single" required=""  style="width: 100%; height: 30PX" name="AMBCODE_E" id="AMBCODE_E" >
          ...
          <div class="col-md-2 col-sm-4 col-xs-6">
            ...
            <select class="form-control select2 js-example-basic-single" required=""  style="width: 100%; height: 30PX" name="TARGETAMBCODE_E" id="TARGETAMBCODE_E" >
              <option value="" selected>Seç...</option>
              @php
                foreach ($depo_evraklar as $key => $veri) {
