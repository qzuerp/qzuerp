                  ...
                  <table class="table table-bordered text-center" id="veriTable" >
                    ...
                    <thead>
                      ...
                      <tr class="satirEkle" style="background-color:#3c8dbc">
                        ...
                        <td style="min-width: 150px">
                          <input maxlength="28" style="color: red" type="number"  name="SF_BAKIYE" id="SF_BAKIYE_SHOW" class="form-control" >
                        </td>
                    ...
                    @foreach ($t_kart_veri as $key => $veri)
                      <tr>
                        ...
                        <td><input type="number" class="form-control" name="SF_BAKIYE_SHOW_T" value="{{ $veri->PRICE2 }}"></td>
                      ...
                      <table id="popupSelect" class="table table-hover text-center table-responsive" data-page-length="10" style="font-size: 0.8em;">
                        <thead>
                          <tr class="bg-primary">
                            ...
                            <th>Birim</th>
                            <th>Ort Temin Süresi</th>
                            <th>Min Sipariş Mik.</th>
                            <th>GK1</th>
                            <th>GK2</th>
                            <th>GK3</th>
                            <th>GK4</th>
                        ...
                        <tfoot>
                         ...
                         <tbody>
                           @php
                             ...
                             foreach ($stok00_evraklar as $key => $veri) {
                                 echo "<tr>";
                                 echo "<td>".trim($veri->KOD)."</td>";
                                 echo "<td>".$veri->AD."</td>";
                                 echo "<td>".$veri->IUNIT."</td>";
                                 echo "<td>".$veri->B_ORTTEMINSURES."</td>";
                                 echo "<td>".$veri->B_MINIMUMSIPMIKTARI."</td>";
                                 echo "<td>".$veri->GK_1."</td>";
                                 echo "<td>".$veri->GK_2."</td>";
                                 echo "<td>".$veri->GK_3."</td>";
                                 echo "<td>".$veri->GK_4."</td>";
                                 echo "<td>".$veri->GK_5."</td>";
                                 echo "<td>".$veri->GK_6."</td>";
                                 echo "<td>".$veri->GK_7."</td>";
                                 echo "<td>".$veri->GK_8."</td>";
                                 echo "<td>".$veri->GK_9."</td>";
                                 echo "<td>".$veri->GK_10."</td>";
                                 echo "</tr>";
                             }
