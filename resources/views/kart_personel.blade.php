...
$ekran = "PERSKART";
$ekranRumuz = "PERS00";
$ekranAdi = "Personel Kartı";
$ekranLink = "kart_personel";
      ...
      <form class="form-horizontal mt-3" action="pers00_islemler" method="POST" name="verilerForm" id="verilerForm">
        ...
        <div class="row">
          <div class="col">
                    ...
                    <div class="row">
                      <div class="col-md-3">
                        ...
                        <select class="form-control select2" id="Iller" name="ADRES_IL" >
                            <option name="ADRES_IL" id="ADRES_IL" value="0">{{ @$kart_veri->ADRES_IL }}</option>
                        </select>
                      </div>
                      ...
                      <div class="col-md-3">
                        ...
                        <select class="form-control select2" id="Ilceler" name="ADRES_ILCE" >
                            <option name="ADRES_ILCE" id="ADRES_ILCE" value="0">{{ @$kart_veri->ADRES_ILCE }}</option>
                        </select>
                      </div>
                      <!-- <div class="col-md-3">
                        <label>İl</label>
                        <select name="ADRES_IL" id="ADRES_IL" class="form-control select2">
                          <option value="">Seç...</option>
                          <option value="İstanbul" @if (@$kart_veri->ADRES_IL == "İstanbul") selected @endif>İstanbul</option>
                        </select>
                      </div>

                      <div class="col-md-3">
                        <label>İlçe</label>
                        <select name="ADRES_ILCE" id="ADRES_ILCE" class="form-control select2">
                          <option>Seç..</option>
                          <option value="Başakşehir" @if (@$kart_veri->ADRES_ILCE == "Başakşehir") selected @endif>Başakşehir</option>
                        </select>
                      </div> -->
                  ...
                  <div class="tab-pane" id="persozlukbilgileri">
                    <div class="row">
                      <div class="col-md-2">
                        ...
                        <input type="text" class="form-control" maxlength="11" name="TC_KIMLIK_NO" id="TC_KIMLIK_NO" value="{{ @$kart_veri->TC_KIMLIK_NO }}">
                      </div>
                      <div class="col-md-2">
                        <label>Anne Adı</label>
                        <input type="text" class="form-control" maxlength="11" name="ANNE_ADI" id="ANNE_ADI" value="{{ @$kart_veri->ANNE_ADI }}">
                      </div>
                      <div class="col-md-2">
                        <label>Baba Adı</label>
                        <input type="text" class="form-control" maxlength="11" name="BABA_ADI" id="BABA_ADI" value="{{ @$kart_veri->BABA_ADI }}">
                      </div>
                      <div class="col-md-2">
                      ...
                      <div class="col-md-2">
                        ...
                        <input type="date" class="form-control" maxlength="16" name="DOGUM_TARIHI" id="DOGUM_TARIHI" value="{{ @$kart_veri->DOGUM_TARIHI }}">
                      </div>
                      <div class="col-md-2">
                        <label>Uyruk</label>
                        <input type="text" class="form-control" maxlength="11" name="UYRUK" id="UYRUK" value="{{ @$kart_veri->UYRUK }}">
                      </div>
                      <div class="col-md-2">
                        <label>Kan Grubu</label>
                        <input type="text" class="form-control" maxlength="6" name="KAN_GRUBU" id="KAN_GRUBU" value="{{ @$kart_veri->KAN_GRUBU }}">
                      </div>
                      <div class="col-md-2">
                        <label>Sağlık Durumu (Hastalık/Alerji)</label>
                        <input type="text" class="form-control" maxlength="20" name="SAGLIK_DURUMU" id="SAGLIK_DURUMU" value="{{ @$kart_veri->SAGLIK_DURUMU }}">
                      </div>
                      <div class="col-md-2">
                        <label>Ünvan</label>
                        <input type="text" class="form-control" maxlength="20" name="NAME2" id="NAME2" value="{{ @$kart_veri->NAME2 }}">
                      </div>
                      <div class="col-md-2">
                        <label>Mail</label>
                        <input type="text" class="form-control" maxlength="50" name="EMAIL" id="EMAIL" value="{{ @$kart_veri->EMAIL }}">
                      ...
                      <div class="col-md-2">
                        <label>İl</label>
                        <select class="form-control" id="Iller" name="ADRES_IL" disabled>
                            <option name="ADRES_IL" id="ADRES_IL" value="0">{{ @$kart_veri->ADRES_IL }}</option>
                        </select>
                      </div>
                      ...
                      <div class="col-md-2">
                        <label>İlçe</label>
                        <select class="form-control" id="Ilceler" name="ADRES_ILCE" disabled="disabled">
                            <option name="ADRES_ILCE" id="ADRES_ILCE" value="0">{{ @$kart_veri->ADRES_ILCE }}</option>
                        </select>
                      </div>
            ...
            <label for="minDeger" class="col-sm-2 col-form-label">Personel Kodu</label>
            <div class="col-sm-3">
                    ...
                    <table id="evrakSuzTable" class="table table-striped text-center" data-page-length="10" style="font-size: 0.8em">
                      ...
                      <tbody>
                        ...
                        foreach ($evraklar as $key => $suzVeri) {
                            ...
                            echo "<td>"."<a class='btn btn-info' href='kart_personel?ID=".$suzVeri->id."'><i class='fa fa-chevron-circle-right' style='color: white'></i></a>"."</td>";
