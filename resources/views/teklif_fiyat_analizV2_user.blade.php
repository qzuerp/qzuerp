			...
			<div class="modal-content">
				...
				<div class="modal-body p-0">
					...
					<ul class="nav nav-tabs nav-tabs-custom px-3 pt-2 bg-light" role="tablist">
						<li class="nav-item">
							<button class="nav-link" data-bs-toggle="tab" data-bs-target="#genel">
					...
					<div class="tab-content overflow-hidden p-4">
						...
						<div class="tab-pane fade show active" id="genel">
							...
							<div class="row g-3 mt-3">
								...
								<div class="col-1">
									<button disabled id="COPY_ROWBTN" class="btn btn-success">Kopyala</button>
								</div>
							</div>
						</div>
						...
						<div class="tab-pane fade" id="operasyonSec">
							<div class="mb-3">
								<div class="d-flex justify-content-between align-items-center mb-1">
									...
									<div>
										<button disabled type="button" class="btn btn-sm btn-primary me-2" id="selectAll">
											<i class="fa-solid fa-check-double" style="color: #ffffff !important;"></i> Tümünü Seç
										</button>
										<button disabled type="button" class="btn btn-sm btn-primary me-2" id="check_default">
											<i class="fa-solid fa-check-double"></i> Standart Operasyonları Seç
										</button>
										<button disabled type="button" class="btn btn-sm btn-secondary" id="deselectAll">
										...
										<div class="table-responsive">
											<div class="nav-tabs-custom">
												<ul class="nav nav-tabs">
													...
													<li><a href="#" class="nav-link">Döviz Kurları</a></li>
													<li><a href="#" class="nav-link">Standart Operasyon Seçim Paneli</a></li>
												</ul>
