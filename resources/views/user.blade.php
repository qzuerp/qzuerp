                                  ...
                                  <tbody>
                                    ...
                                    <tr>
                                      ...
                                      <td><input type="checkbox" class="yetki_read" id="calismabildirimi_read"
                                          ...
                                          echo " checked" @endphp></td>
                                      <td><input type="checkbox" class="yetki_write" id="calismabildirimi_write"
                                          name="yetki_write[]" value="AKTIFIS" @php if (in_array('AKTIFIS', $kullanici_write_yetkileri))
                                          echo " checked" @endphp></td>
                                      <td><input type="checkbox" class="yetki_delete" id="calismabildirimi_delete"
                                          name="yetki_delete[]" value="AKTIFIS" @php if (in_array('AKTIFIS', $kullanici_delete_yetkileri))
                                          echo " checked" @endphp></td>
                                    </tr>
                                    <tr>
                                      <td>Kontakt Kartı</td>
                                    ...
                                    <tr>
                                      <td>Takip Listeleri</td>
                                      <td><input type="checkbox" class="yetki_read" id="DYS_read" name="yetki_read[]"
                                          value="TAKIPLISTE" @php if (in_array('TAKIPLISTE', $kullanici_read_yetkileri))
                                          echo " checked" @endphp></td>
                                      <td><input type="checkbox" class="yetki_write" id="DYS_write" name="yetki_write[]"
                                          value="TAKIPLISTE" @php if (in_array('TAKIPLISTE', $kullanici_write_yetkileri))
                                          echo " checked" @endphp></td>
                                      <td><input type="checkbox" class="yetki_delete" id="DYS_delete" name="yetki_delete[]"
                                          value="TAKIPLISTE" @php if (in_array('TAKIPLISTE', $kullanici_delete_yetkileri))
                                          echo " checked" @endphp></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                      ...
                                      <td><input type="checkbox" class="yetki_read" id="DYS_read" name="yetki_read[]"
                                          value="PRYBKM" @php if (in_array('PRYBKM', $kullanici_read_yetkileri))
                                          echo " checked" @endphp></td>
                                      <td><input type="checkbox" class="yetki_write" id="DYS_write" name="yetki_write[]"
                                          value="PRYBKM" @php if (in_array('PRYBKM', $kullanici_write_yetkileri))
                                          echo " checked" @endphp></td>
                                      <td><input type="checkbox" class="yetki_delete" id="DYS_delete" name="yetki_delete[]"
