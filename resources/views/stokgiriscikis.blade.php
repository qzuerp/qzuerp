                      ...
                      <tbody>
                        @foreach ($t_kart_veri as $key => $veri)
                          <tr>
                            ...
                            <td><input type="text" readonly class="form-control KOD" name="KOD[]" value="{{ $veri->KOD }}"></td>
                            ...
                            <td><input type="text" class="form-control LOCATION1" id="lok1-{{ $veri->id }}-CAM" name="LOCATION1[]" value="{{ $veri->LOCATION1 }}" style="color: blue;" readonly></td>
                            <td><input type="text" class="form-control LOCATION2" id="lok2-{{ $veri->id }}-CAM" name="LOCATION2[]" value="{{ $veri->LOCATION2 }}" style="color: blue;" readonly></td>
                            <td><input type="text" class="form-control LOCATION3" id="lok3-{{ $veri->id }}-CAM" name="LOCATION3[]" value="{{ $veri->LOCATION3 }}" style="color: blue;" readonly></td>
                            <td><input type="text" class="form-control LOCATION4" id="lok4-{{ $veri->id }}-CAM" name="LOCATION4[]" value="{{ $veri->LOCATION4 }}" style="color: blue;" readonly></td>
