...
@php
  ...
  $ekran = "DDTRANSFER";
  $ekranRumuz = "STOK26";
  $ekranAdi = "Depodan Depoya Transfer";
  $ekranLink = "depodandepoyatransfer";
  $ekranTableE = $database ."stok26e";
  $ekranTableT = $database ."stok26t";
...
<style>
  ...
  <div class="content-wrapper">
    ...
    @include('layout.util.evrakContentHeader')
		@include('layout.util.logModal',['EVRAKTYPE' => 'STOK26','EVRAKNO'=>@$kart_veri->EVRAKNO])

      <section class="content">
        <form method="POST" action="stok26_islemler" method="POST" name="verilerForm" id="verilerForm">
          @csrf
                        ...
                        <table class="table table-bordered text-center" id="veriTable" >
                          <thead>
                            ...
                            <tr class="satirEkle" style="background-color:#3c8dbc">
                              ...
                              <td style="min-width: 150px">
                                <input maxlength="28" style="color: red" type="text" name="SF_MIKTAR_FILL" id="SF_MIKTAR_FILL" class="form-control" disabled>
                              </td>
                              <td style="min-width: 150px">
                  ...
                  <table id="evrakSuzTable" class="table table-striped text-center" data-page-length="10" style="font-size: 0.8em">
                    ...
                    <tbody>
                      ...
                      foreach ($evraklar as $key => $suzVeri) {
                          ...
                          echo "<td>"."<a class='btn btn-info' href='depodandepoyatransfer?ID=".$suzVeri->id."'><i class='fa fa-chevron-circle-right' style='color: white'></i></a>"."</td>";
                  ...
                  <table id="evrakSuzTable2" class="table table-striped text-center" data-page-length="10" style="font-size: 0.8em">
                    ...
                    <tbody>
                      ...
                      $evraklar = DB::table($ekranTableT)
                          ->leftJoin($ekranTableE, 'stok26e.EVRAKNO', '=', 'stok26t.EVRAKNO')
                          ->orderBy('stok26t.id', 'ASC')
                          ->get();
    ...
    <!-- <script>
      ...
      <script>
        ...
        function getNewLocation1() {
          ...
          $.ajax({
              ...
              success: function (response) {
                ...
                $('#LOCATION_NEW1_FILL2').find('option').remove().end();
                $('#LOCATION_NEW1_FILL2').find('option').remove().end().append('<option value=" ">Seç</option>');

                //$('#LOCATION1_FILL').find('option').empty();
                $('#LOCATION_NEW1_FILL2').append(response);
        ...
        function getNewLocation2() {
          ...
          var TARGETAMBCODE_E = document.getElementById("TARGETAMBCODE_E").value;
          var LOCATION_NEW1_FILL = document.getElementById("LOCATION_NEW1_FILL").value.trim();
          if (LOCATION_NEW1_FILL === "") {
              LOCATION_NEW1_FILL = document.getElementById("LOCATION_NEW1_FILL2").value.trim();
          }
          ...
          $.ajax({
              ...
              success: function (response) {
                ...
                $('#LOCATION_NEW2_FILL2').find('option').remove().end();
                $('#LOCATION_NEW2_FILL2').find('option').remove().end().append('<option value=" ">Seç</option>');

                //$('#LOCATION1_FILL').find('option').empty();
                $('#LOCATION_NEW2_FILL2').append(response);
        ...
        function getNewLocation3() {
         ...
         $.ajax({
             ...
             success: function (response) {
               ...
               $('#LOCATION_NEW3_FILL2').find('option').remove().end();
               $('#LOCATION_NEW3_FILL2').find('option').remove().end().append('<option value=" ">Seç</option>');

               //$('#LOCATION1_FILL').find('option').empty();
               $('#LOCATION_NEW3_FILL2').append(response);
          ...
          var LOCATION_NEW3_FILL = document.getElementById("LOCATION_NEW3_FILL").value;
           ...
           $.ajax({
               ...
               success: function (response) {
                 ...
                 $('#LOCATION_NEW4_FILL2').find('option').remove().end();
                 $('#LOCATION_NEW4_FILL2').find('option').remove().end().append('<option value=" ">Seç</option>');

                 $('#LOCATION_NEW4_FILL2').append(response);
