...
@php
  ...
  $ekran = "SATISFAT";
  $ekranRumuz = "STOK70";
  $ekranAdi = "Satış Faturaları";
  $ekranLink = "satis_faturalari";
  $ekranTableE = $database."stok70e";
  $ekranTableT = $database."stok70t";
  ...
  if(isset($_GET['ID'])) {
    ...
    $sonID = DB::table($ekranTableE)->max('EVRAKNO');
  }
...
@section('content')
    <div class="content-wrapper" >
        ...
        <section class="content">
            ...
            <form method="POST" action="stok70_islemler" method="POST" name="verilerForm" id="verilerForm">
                @csrf
                <div class="row">
                    <div class="col-12">
                    ...
                    <div class="col-12">
                        <div class="box box-info">
                            <div class="box-body">
                                <button class="btn btn-primary mb-2" type="submit" name="kart_islemleri" value="muhasebeVerileriGetir"><i class="fa fa-plus" style="color: blue"></i> Muhasebeden verileri getir</button>
                                    ...
                                    <table class="table table-bordered table-striped" id="veriTable">
                                        ...
                                        <tbody>
                                            @foreach ($t_kart_veri as $veri)
                                                ...
                                                <td><input type='text' class='form-control' name='AD[]' value='{{ $veri->STOK_ADI }}'></td>
                                                <td><input type='text' class='form-control' name='MIKTAR[]' value='{{ $veri->SF_MIKTAR }}'></td>
                                                <td><input type='text' class='form-control' name='FIYAT[]' value='{{ $veri->FIYAT }}'></td>
                                                <td><input type='text' class='form-control' name='TUTAR[]' value='{{ $veri->TUTAR }}'></td>
