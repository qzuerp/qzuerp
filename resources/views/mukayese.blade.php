...
@section('content')
  <style>
    ...
    .muk-btn-blue:hover:not(:disabled) {
      background: #1d4ed8;
    ...
    .muk-btn-red:hover:not(:disabled) {
      background: #b91c1c;
    ...
    .muk-btn-amber:hover:not(:disabled) {
      background: #b45309;
    ...
    #veriTable tbody tr:hover td {
      background: #f8fafc;
    }

    /* row colors */
    #veriTable tbody tr.muk-neg td {
      background: #fff5f5;
    }

    #veriTable tbody tr.muk-pos td {
      background: #fffbeb;
    }

    #veriTable tbody tr.muk-neg:hover td {
      background: #fee2e2;
    }

    #veriTable tbody tr.muk-pos:hover td {
      background: #fef3c7;
    }
              ...
              <div class="muk-stat-acc-inner">
                <div class="muk-ring-wrap">
                  <svg viewBox="0 0 64 64" width="64" height="64">
                    ...
                    <circle class="muk-ring-fill" id="ringFill" cx="32" cy="32" r="28" stroke="#22c55e"
