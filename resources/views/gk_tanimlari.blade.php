     ...
     <div>
        ...
        <div class="row ">
          <div class="col-md-2 col-sm-3 col-xs-6">
            ...
            <input type="text" class="form-control" maxlength="24"  name="EVRAKNO_E" id="EVRAKNO_E" required="" value="{{ @$kart_veri->EVRAKNO }}" >
          </div>

          <div class="col-md-2 col-sm-3 col-xs-6">
            <label>Ad</label>
            <input type="text" class="form-control" name="AD_E" id="AD_E" required="" value="{{ @$kart_veri->AD }}">
          </div>
  ...
  <div class="col-12">
    <div class="nav-tabs-custom box box-info">
      ...
      <div class="tab-content">
        ...
        <div class="row">
                    <div class="col my-2">
											<button type="button" class="btn btn-default delete-row" id="deleteRow"><i class="fa fa-minus" style="color: red"></i> Seçilenleri Sil</button>
                    </div>
