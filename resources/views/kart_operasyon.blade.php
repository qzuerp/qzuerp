				...
				@include('layout.util.evrakIslemleri')
						...
						<div class="row ">
							<div class="col-md-3 col-sm-4 col-xs-6">
								<label>Kod</label>
								<input type="text" class="form-control input-sm KOD" data-bs-toggle="tooltip" data-bs-container="botte" data-bs-placement="bottom" data-bs-title="KOD" name="KOD" id="KOD" maxlength="16"  value="{{ @$kart_veri->KOD }}">
							</div>
