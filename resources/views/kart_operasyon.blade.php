				...
				@include('layout.util.evrakIslemleri')
						...
						<div class="row ">
							<div class="col-md-3 col-sm-4 col-xs-6">
								<label>Kod</label>
								<input type="text" class="form-control input-sm" name="KOD" id="KOD" maxlength="16"  value="{{ @$kart_veri->KOD }}">
							</div>

							<div class="col-md-3 col-sm-4 col-xs-6">
								<label>Ad</label>
								<input type="text" class="form-control input-sm" name="AD" id="AD" maxlength="50"  value="{{ @$kart_veri->AD }}">
							</div>
