								...
								<div class="row ">
									...
									<div class="col-md-2 col-xs-2">
										<input type="text" class="form-control input-sm" maxlength="16" name="firma"
											id="firma" value="{{ @$kullanici_veri->firma }}" disabled><input type="hidden"
											maxlength="16" class="form-control input-sm" name="firma" id="firma"
											value="{{ @$kullanici_veri->firma }}">
									</div>
								...
								<div class="row ">
									<div class="col-md-3 col-sm-4 col-xs-6">
										...
										<input type="text" class="form-control EVRAKNO" data-bs-toggle="tooltip"
											data-bs-placement="top" data-bs-title="EVRAKNO" name="EVRAKNO" id="EVRAKNO"
											maxlength="16" value="{{ @$kart_veri->EVRAKNO }}" disabled>
										<input type="hidden" class="form-control " name="EVRAKNO" id="EVRAKNO"
											maxlength="16" value="{{ @$kart_veri->EVRAKNO }}">

									</div>
									<div class="col-md-3 col-sm-4 col-xs-6">
										<label>Tarih</label>
										<input type="date" class="form-control TARIH" data-bs-toggle="tooltip"
											data-bs-placement="top" data-bs-title="TARIH" data-max name="TARIH" id="TARIH"
											value="{{ @$kart_veri->TARIH }}">
									</div>
									<div class="col-md-3 col-sm-4 col-xs-6">
										<label>Ad Soyad</label>
										<input type="text" class="form-control AD_SOYAD" data-bs-toggle="tooltip"
											data-bs-placement="top" data-bs-title="AD_SOYAD" name="AD_SOYAD" data-max
											name="AD_SOYAD" id="AD_SOYAD" value="{{ @$kart_veri->AD_SOYAD }}">
									</div>
						...
						<div class="box box-info p-4">
							<div class="nav-tabs-custom">
								<ul class="nav nav-tabs">
									<li class="nav-item"><a href="#sirketbilgileri" class="nav-link"
											...
											<div class="row">
												...
												<div class="col-xs-6 col-md-3 col-sm-6">
													...
													<select class="form-control js-example-basic-single select2"
														...
														data-bs-title="AD_SOYAD" name="SIRKET_CH_KODU_SHOW"
														id="SIRKET_CH_KODU_SHOW" onchange="cariBilgileriGetir(this.value)">
														@php
													...
													<input type="hidden" class="form-control" data-max name="SIRKET_CH_KODU"
														id="SIRKET_CH_KODU" value="{{ @$kart_veri->SIRKET_CH_KODU }}">
												</div>
												<div class="col-xs-6 col-md-3 col-sm-6">
													<label>Şirket Adı</label>
													<input type="text" class="form-control SIRKET_ADI"
														data-bs-toggle="tooltip" data-bs-placement="top"
														data-bs-title="SIRKET_ADI" data-max style="color:red"
														name="SIRKET_ADI" id="SIRKET_ADI"
														value="{{ @$kart_veri->SIRKET_ADI }}" disabled>
												</div>

												<div class="col-xs-6 col-md-3 col-sm-6">
													<label>İş Telefonu</label>
													<input type="text" class="form-control SIRKET_IS_TEL"
														data-bs-toggle="tooltip" data-bs-placement="top"
														data-bs-title="SIRKET_IS_TEL" data-max style="color:red"
														name="SIRKET_IS_TEL" id="SIRKET_IS_TEL"
														value="{{ @$kart_veri->SIRKET_IS_TEL }}">
												</div>

												<div class="col-xs-6 col-md-3 col-sm-6">
													<label>Dahili</label>
													<input type="text" class="form-control DAHILI" data-bs-toggle="tooltip"
														data-bs-placement="top" data-bs-title="DAHILI" data-max
														name="DAHILI" id="DAHILI" value="{{ @$kart_veri->DAHILI }}">
												</div>

												<div class="col-xs-6 col-md-3 col-sm-6">
													<label>Fax</label>
													<input type="text" class="form-control FAXNO" data-bs-toggle="tooltip"
														data-bs-placement="top" data-bs-title="FAXNO" data-max
														style="color:red" name="FAXNO" id="FAXNO"
														value="{{ @$kart_veri->FAXNO }}" disabled>
												</div>

												<div class="col-xs-6 col-md-3 col-sm-6">
													<label>E-posta </label>
													<input type="text" class="form-control SIRKET_EMAIL_1"
														data-bs-toggle="tooltip" data-bs-placement="top"
														data-bs-title="SIRKET_EMAIL_1" maxlength="100" name="SIRKET_EMAIL_1"
														id="SIRKET_EMAIL_1" value="{{ @$kart_veri->SIRKET_EMAIL_1 }}">
												</div>

												<div class="col-xs-6 col-md-3 col-sm-6">
													<label>Web Adresi</label>
													<input type="text" class="form-control SIRKET_WEB_ADR_1"
														data-bs-toggle="tooltip" data-bs-placement="top"
														data-bs-title="SIRKET_WEB_ADR_1" name="SIRKET_WEB_ADR_1"
														id="SIRKET_WEB_ADR_1" value="{{ @$kart_veri->SIRKET_WEB_ADR_1 }}">
												</div>
