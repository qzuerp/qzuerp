					...
					<div class="col-xs-12">
						...
						<div class="box-body table-responsive">
							...
							<div class="nav-tabs-custom">
								...
								<table class="table table-bordered text-center" id="veriTable" style="overflow:visible;border-radius:10px">
								...
								<thead>
									...
									@foreach ($t_kart_veri as $key => $veri)
										...
										<td><input type="number" class="form-control" name="NUM4[]" value="{{ $veri->NUM4 }}"></td>
																...
																<td style="display: none;"><input type="text" class="form-control" name="SIPARTNO[]" value="{{ $veri->SIPARTNO }}" hidden></td>
