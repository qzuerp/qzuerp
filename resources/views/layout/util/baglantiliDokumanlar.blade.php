...
<div class="container-fluid">
  <ul class="nav nav-tabs" id="dosyaTab" role="tablist">
    <li class="nav-item" role="presentation">
      <button class="nav-link active" id="dosya-tab" data-bs-toggle="tab" data-bs-target="#dosyaIslemleri" type="button" role="tab" aria-controls="dosyaIslemleri" aria-selected="true">
        <i class="fa fa-file-text me-2"></i>Dosya İşlemleri
      </button>
    </li>
    <li class="nav-item" role="presentation">
  ...
  <div class="tab-content" id="dosyaTabContent">
    <div class="tab-pane fade show active" id="dosyaIslemleri" role="tabpanel" aria-labelledby="dosya-tab">
    ...
    <div class="tab-pane fade" id="excelAktar" role="tabpanel" aria-labelledby="excel-tab">
        @include('layout.util.excel_aktar')
    </div>
  </div>
</div>