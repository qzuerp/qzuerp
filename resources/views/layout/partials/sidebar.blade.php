...
<div class="sidebar">
  <div class="logo-details">
    ...
    @if($FIRMA)
      <img src="{{ asset($FIRMA->LOGO_URL) }}" width='50' style='object-fit:cover; width:50px !important; transform:scale(0.80); height:50px; border 1px solid white; border-radius: 50%;' alt="User Image" alt="{{ $FIRMA->FIRMA_ADI }}" loading="lazy">
    @else
    ...
    <li class="treeview">
      ...
      <ul class="treeview-menu">
        ...
        @if (in_array('CGC70', $kullanici_read_yetkileri))
          <li><a href="musteri_sikayet"><i class='bx bx-message-error'></i> Öğrenilmiş dersler / Müşteri Şikayetleri</a></li>
        @endif
