              ...
              <div class="tab-content">
                    ...
                    <table class="table table-bordered text-center" id="veriTable" style="width:100%;font-size:7pt; overflow:visible; border-radius:10px !important; margin-left: 12px;">
                      ...
                      <thead>
                        ...
                        <tr class="satirEkle" style="background-color:#3c8dbc">
                          ...
                          <td style="min-width: 150px">
                            <input maxlength="28" style="color: red" type="number" data-name="FIYAT" name="FIYAT" id="FIYAT_SHOW" class="form-control">
                          </td>
                          <td>
                          ...
                          <td style="min-width: 150px">
                            <input maxlength="6 "style="color: red" type="text" name="SF_SF_UNIT_FILL" id="SF_SF_UNIT_SHOW" class="form-control" disabled>
                            <input maxlength="6 "style="color: red" type="hidden" name="SF_SF_UNIT_FILL" id="SF_SF_UNIT_FILL" class="form-control">
                          </td>
                          <td style="min-width: 150px">
                            <input maxlength="6 "style="color: red" type="text" name="SF_BAKIYE" id="SF_BAKIYE_SHOW" class="form-control" disabled>
                          </td>
                          <td style="min-width: 150px">
                            <input maxlength="255" style="color: red" type="date"  data-name="TERMIN_TAR"  name="TERMIN_TAR_FILL" id="TERMIN_TAR_FILL" class="form-control">
                          </td>
                          <td style="min-width: 150px">
                            <input maxlength="255" style="color: red" type="text"  data-name="NOT1"  name="NOT1_FILL" id="NOT1_FILL" class="form-control">
                          </td>
                          <td>
                      ...
                      @foreach ($t_kart_veri as $key => $veri)
                        <tr>
                          ...
                          <td><input type="text" class="form-control"  name="LOTNUMBER[]" value="{{ $veri->LOTNUMBER }}"></td>
                          ...
                          <td>
                            <input type="text" data-name="FIYAT_PB[]" name="FIYAT_PB[]" class="form-control" readonly value="{{ $veri->FIYAT_PB }}" id="">
                          </td>
                          <td><input type="text" class="form-control" name="SF_SF_UNIT_SHOW_T" value="{{ $veri->SF_SF_UNIT }}" disabled><input type="hidden" class="form-control" data-name="SF_SF_UNIT[]" name="SF_SF_UNIT[]" value="{{ $veri->SF_SF_UNIT }}"></td>
                          <td><input type="text" class="form-control" name="SF_BAKIYE_SHOW_T" value="{{ $veri->SF_BAKIYE }}" disabled></td>
                          ...
                          <td>
                            ...
                            <input type="text" name="MPS_KODU[]" class="form-control" value="{{ $veri->MPS_KODU }}" readonly>
                          </td>
                          <td><input type="text" class="form-control" data-name="TEXT1[]" name="TEXT1[]" value="{{ $veri->TEXT1 }}"></td>
                          <td><input type="text" class="form-control" data-name="TEXT2[]" name="TEXT2[]" value="{{ $veri->TEXT2 }}"></td>
                          <td><input type="text" class="form-control" data-name="TEXT3[]" name="TEXT3[]" value="{{ $veri->TEXT3 }}"></td>
                          <td><input type="text" class="form-control" data-name="TEXT4[]" name="TEXT4[]" value="{{ $veri->TEXT4 }}"></td>
                          <td><input type="number" class="form-control" data-name="NUM1[]"name="NUM1[]" value="{{ $veri->NUM1 }}"></td>
                          <td><input type="number" class="form-control" data-name="NUM2[]"name="NUM2[]" value="{{ $veri->NUM2 }}"></td>
                          <td><input type="number" class="form-control" data-name="NUM3[]"name="NUM3[]" value="{{ $veri->NUM3 }}"></td>
                          <td><input type="number" class="form-control" data-name="NUM4[]"name="NUM4[]" value="{{ $veri->NUM4 }}"></td>
                ...
                <div class="tab-pane" id="liste">
                  ...
                  <div class="row " style="overflow: auto">
                    ...
                    <table id="example2" class="table table-striped text-center" data-page-length="50" style="font-size: 0.75em">
                      <thead>
                        <tr class="bg-primary">
                          <th>Sipariş No</th>
                          <th>Tedarikçi</th>
                      ...
                      <tbody>
                        @php
                          ...
                          if (isset($_GET['DURUM'])) {$DURUM = 'A';}else{$DURUM = 'K';}
