...
<div class="modal fade bd-example-modal-lg" id="modal_depo_mevcutlari" tabindex="-1" role="dialog"
    aria-labelledby="modal_depo_mevcutlari">
...
<div class="modal fade bd-example-modal-lg" id="modal_stok_hareketleri" tabindex="-1" role="dialog"
    aria-labelledby="modal_stok_hareketleri">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
