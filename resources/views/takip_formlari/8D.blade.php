<div class="form" style="display:none;" id="8D">
    ...
    <div class=" mb-3">
        <div class="row g-2">
            ...
            <div class="col-md-4">
                ...
                <input type="date" class="form-control" name="report_date" value="<?php echo date('Y-m-d'); ?>"
                    required>
            </div>
            <div class="col-md-4">
                <label class="form-label">Sorumlu Ekip</label>
                <input type="text" class="form-control" name="team" placeholder="Ekip adı / lider">
            </div>
        </div>
    </div>
                ...
                <div class="accordion-body">
                    <div class="mb-3">
                        ...
                        <textarea class="form-control textarea-resize" name="d1_team"
                            placeholder="Örn: Ali Yılmaz - Süreç Lideri"></textarea>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div id="collapse2" class="accordion-collapse collapse" data-bs-parent="#accordion8d">
                <div class="accordion-body">
                    <div class="mb-3">
                        ...
                        <textarea class="form-control textarea-resize" name="d2_description" required></textarea>
                    </div>
                    <div class="row g-2">
                        <div class="col-md-4">
                            <label class="form-label">Yer / Süreç</label>
                            <input type="text" class="form-control" name="d2_area">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">Frekans</label>
                            <input type="text" class="form-control" name="d2_frequency" placeholder="Örn: 3/hafta">
                        </div>
                        <div class="col-md-4">
            ...
            <div id="collapse4" class="accordion-collapse collapse" data-bs-parent="#accordion8d">
                <div class="accordion-body">
                    <div class="mb-3">
                        ...
                        <textarea class="form-control textarea-resize" name="d4_rootcause"></textarea>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Kullanılan Metod</label>
                        <input type="text" class="form-control" name="d4_method" placeholder="Örn: 5-Why, Fishbone">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="accordion-item">
            ...
            <div id="collapse5" class="accordion-collapse collapse" data-bs-parent="#accordion8d">
                <div class="accordion-body">
                    ...
                    <div class="small-note">Listeye ekledikten sonra düzenleyebilirsiniz.
                    </div>
                </div>
            </div>
        </div>
            ...
            <div id="collapse6" class="accordion-collapse collapse" data-bs-parent="#accordion8d">
                <div class="accordion-body">
                    <div class="mb-3">
                        ...
                        <textarea class="form-control textarea-resize" name="d6_results"></textarea>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Doğrulama Tarihi</label>
                        <input type="date" class="form-control" name="d6_verified_at">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div id="collapse7" class="accordion-collapse collapse" data-bs-parent="#accordion8d">
                <div class="accordion-body">
                    <div class="mb-3">
                        ...
                        <textarea class="form-control textarea-resize" name="d7_preventive"></textarea>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="accordion-body">
                    <div class="row g-2">
                        <div class="col-md-6">
                            ...
                            <textarea class="form-control textarea-resize" name="d8_closure"></textarea>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Onaylayan</label>
                            <input type="text" class="form-control mb-2" name="d8_approved_by"
                                placeholder="İsim - Unvan">
                            <label class="form-label">Onay Tarihi</label>
                            <input type="date" class="form-control" name="d8_approved_at">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="card mt-3 mb-4">
        <div class="card-body">
            <div class="mb-3">
                <label class="form-label">Ek Dosyalar (log, resim, rapor)</label>
                <input class="form-control" type="file" name="attachments[]" multiple>
            </div>

            <div class="mb-3">
                <label class="form-label">Genel Notlar</label>
                <textarea class="form-control textarea-resize" name="notes"></textarea>
            </div>
