                ...
                <div class="row">
                    <div class="col">
                        <div class="box box-info">
                            ...
                            <table class="info-table">
                                <tr>
                                    <td style="width: 500px !important;">
                                        ...
                                        <select name="MUSTERI" id="musteri" required=" " onchange="musteriGetir()" class="select2 form-control">
                                    ...
                                    <td>
                                        ...
                                        <input type="text" class="form-control" readonly name="SERVIS_NO" value="{{@$kart_veri->EVRAKNO}}" id="SERVIS_NO">
                                    </td>
                                </tr>
                                <tr>
                            ...
                            <table class="info-table">
                                <tr>
                                    <td><strong>Talep Eden Kişi:</strong> <input type="text" class="form-control" class="form-control" name="TALEP_EDEN_KISI" value="{{@$kart_veri->TALEP_EDEN_KISI}}" id=""></td>
                                    <td><strong>Talep Edilen Tarih:</strong> <input type="date" class="form-control" name="TALEP_EDILEN_TARIH" value="{{@$kart_veri->TALEP_EDILEN_TARIH}}" id=""></td>
                                </tr>
                                <tr>
                                    <td><strong>Talep Edilen Hizmet:</strong> <input type="text" class="form-control" name="TALEP_EDILEN_HIZMET" value="{{@$kart_veri->TALEP_EDILEN_HIZMET}}" id=""></td>
                                    <td><strong>Yapılması İstenen:</strong> <input type="text" class="form-control" name="YAPILMASI_ISTENEN" value="{{@$kart_veri->YAPILMASI_ISTENEN}}" id=""></td>
                                </tr>
                            </table>
                            ...
                            <table class="service-table">
                                ...
                                <tr>
                                    <td><input type="text" class="form-control" name="HIZMET_VEREN_KISI" value="{{@$kart_veri->HIZMET_VEREN_KISI}}" id=""></td>
                                    <td><input type="date" class="form-control" name="TARIH" value="{{@$kart_veri->TARIH}}" id=""></td>
                                    <td><input type="time" class="form-control" name="SAAT" value="{{@$kart_veri->SAAT}}" id=""></td>
                                </tr>
                            </table>
                            ...
                            <p>
                                <textarea name="YAPILAN_IS" class="" style="width: 100%; resize: vertical;" rows="10">{{@$kart_veri->YAPILAN_IS}}</textarea>
                            </p>
