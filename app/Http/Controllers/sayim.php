  ...
  public function mukayeseIslemler(Request $request)
  {
      ...
      $sql = "
        ...
        SELECT 
            ...
            ISNULL(SIS.MIKTAR, 0) AS MIKTAR, 
            (ISNULL(S.SAYILAN_MIKTAR, 0) - ISNULL(SIS.MIKTAR, 0)) AS FARK 
        FROM Sayim S 
        FULL OUTER JOIN {$firma}vw_stok01 SIS ON 
        ...
        WHERE (ISNULL(S.SAYILAN_MIKTAR, 0) - ISNULL(SIS.MIKTAR, 0)) <> 0 and SIS.AMBCODE IN (SELECT AMBCODE FROM EvrakAmbar)
      ";
