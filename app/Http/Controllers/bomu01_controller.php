  ...
  public function islemler(Request $request)
  {
    ...
    switch ($islem_turu) {
      ...
      case 'kart_sil':
        ...
        // dd('sil');
        $msg = FunctionHelpers::KodKontrol($MAMULCODE,['bomu01e','bomu01t','stok40e','stok40t','stok21t','sfdc31e','stok20t','stok60t','stok48t','stok46e','stok46t','stok29e','stok29t']);
      ...
      case 'kart_olustur':
        ...
        for ($i = 0; $i < $satir_say; $i++) {
          ...
          DB::table(trim($firma) . '.dbo.' . 'bomu01t')->insert([
            ...
            //'BOMREC_KAYNAK0_BV' => $BOMREC_KAYNAK0_BV[$i] ?? NULL,
            //'BOMREC_KAYNAK0_BU' => $BOMREC_KAYNAK0_BU[$i] ?? NULL,
