...
class pers00_opt_controller extends Controller
{
  ...
  public function islemler(Request $request) {
    ...
    $GK_14 = $request->input('GK_14');
    $GK_15 = $request->input('GK_15');
    $GK_16 = $request->input('GK_16');
    $GK_17 = $request->input('GK_17');
    $GK_18 = $request->input('GK_18');
    $GK_19 = $request->input('GK_19');
    $GK_20 = $request->input('GK_20');
