...
class pers00_pers_controller extends Controller
{
  public function index()
  {
    $sonID=DB::table('pers00')->min('id');

    return view('kart_personel')->with('sonID', $sonID);
  }
  ...
  public function islemler(Request $request) {
    ...
    // Özlük Bilgileri İçin Eklenen Yeni Alanlar 
    $TC_KIMLIK_NO = $request->input('TC_KIMLIK_NO');
    $DOGUM_TARIHI = $request->input('DOGUM_TARIHI');
    $KAN_GRUBU = $request->input('KAN_GRUBU');
    $SAGLIK_DURUMU = $request->input('SAGLIK_DURUMU');
    $EGITIM_DURUMU = $request->input('EGITIM_DURUMU');
    $GIYSI_BEDENI = $request->input('GIYSI_BEDENI');
    $GIRIS_TARIHI = $request->input('GIRIS_TARIHI');
    $CIKIS_TARIHI = $request->input('CIKIS_TARIHI');
    $ANNE_ADI = $request->input('ANNE_ADI');
    $BABA_ADI = $request->input('BABA_ADI');
    $DOGUM_YERI = $request->input('DOGUM_YERI');
    $UYRUK = $request->input('UYRUK');
    ...
    case 'listele':
      ...
      return redirect()->route('kart_personel', ['SUZ' => 'SUZ','KOD_B' => $KOD_B, 'KOD_E' => $KOD_E, 'GK_1_B' => $GK_1_B, 'GK_1_E' => $GK_1_E, 'GK_2_B' => $GK_2_B, 'GK_2_E' => $GK_2_E, 'GK_3_B' => $GK_3_B, 'GK_3_E' => $GK_3_E, 'GK_4_B' => $GK_4_B, 'GK_4_E' => $GK_4_E, 'GK_5_B' => $GK_5_B, 'GK_5_E' => $GK_5_E, 'GK_6_B' => $GK_6_B, 'GK_6_E' => $GK_6_E, 'GK_7_B' => $GK_7_B, 'GK_7_E' => $GK_7_E, 'GK_8_B' => $GK_8_B, 'GK_8_E' => $GK_8_E, 'GK_9_B' => $GK_9_B, 'GK_9_E' => $GK_9_E, 'GK_10_B' => $GK_10_B, 'GK_10_E' => $GK_10_E]);
      print_r("mesaj mesaj");
         break;
    ...
    case 'kart_olustur':
      ...
      return redirect()->route('kart_personel', ['ID' => $sonID, 'kayit' => 'ok']);
...
FunctionHelpers::Logla('PERS00',$KOD,'W');
    ...
    DB::table($firma.'pers00')->where('KOD',$KOD)->update([
      ...
      return redirect()->route('kart_personel', ['ID' => $veri->id, 'duzenleme' => 'ok']);
