...
class deneme1 extends Controller
{
...
//     $veri=DB::table('imlt01')->where('id',$id)->first();
...
//     DB::table('imlt01')->upsert([
//       ['kod' =>   $kod, 'ad' => $ad]
//     ], ['kod']);

//     $query = DB::table('imlt01')->select('kod');
...
//     DB::table('imlt01')->where('KOD',$KOD)->delete();
...
//     DB::table('imlt01')->where('KOD',$KOD)->update([
//       'KOD' => $KOD,
//       'AD' => $AD,
//       'AP10' => $AP10,
//       'GK_1' => $GK_1,
...
//       $veri=DB::table('imlt01')->where('KOD',$KOD)->first();
